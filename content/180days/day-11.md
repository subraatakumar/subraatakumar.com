...
### Prompt to refactor the screen using [5 Layer architecture](/180days/5_layer_architecture/)
...
-   **React Hooks:** [Official Introduction to Hooks](https://react.dev/reference/react/hooks) - The best place to start understanding `useState`, `useEffect`, and the logic behind custom hooks.
-   **Building Your Own Hooks:** [React Docs on Custom Hooks](https://react.dev/learn/reusing-logic-with-custom-hooks) - A guide to extracting component logic into reusable functions, just like we did with `useArchiveEntries`.
-   **React Native Styling:** [StyleSheet API Documentation](https://reactnative.dev/docs/stylesheet) - The official reference for React Native's styling system.
-   **Styling Cheatsheet:** [React Native vs. Web CSS](https://github.com/vhpoet/react-native-styling-cheat-sheet) - An excellent resource for manual style translations.
-   **GitHub Copilot Best Practices:** [Getting the most out of GitHub Copilot](https://github.blog/2023-06-20-getting-the-most-out-of-github-copilot/) - Tips for writing effective prompts.

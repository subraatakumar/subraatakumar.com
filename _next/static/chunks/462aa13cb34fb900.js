(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,69769,e=>{"use strict";var i=e.i(43476),s=e.i(71645);let r=[{id:"offline",icon:"📱",label:"Offline Architecture"},{id:"collection",icon:"🗂️",label:"Data We Collect"},{id:"advertising",icon:"📢",label:"Advertising (AdMob)"},{id:"purchases",icon:"💳",label:"Pro Purchases"},{id:"backups",icon:"☁️",label:"Cloud Backups"},{id:"platforms",icon:"🔗",label:"Platform Links"},{id:"usage",icon:"ℹ️",label:"How Data Is Used"},{id:"permissions",icon:"🔔",label:"App Permissions"},{id:"security",icon:"🔒",label:"Security & Retention"},{id:"rights",icon:"✅",label:"User Rights"},{id:"contact",icon:"✉️",label:"Contact Us"}];function o({icon:e,title:s}){return(0,i.jsxs)("div",{className:"shp-section-head",children:[(0,i.jsx)("div",{className:"shp-section-icon",children:e}),(0,i.jsx)("h2",{className:"shp-h2 sh-font-display",children:s})]})}function a(){return(0,i.jsx)("div",{className:"shp-divider"})}function t({title:e,children:s,gold:r=!1}){return(0,i.jsxs)("div",{className:`shp-callout${r?" shp-callout-gold":""}`,children:[(0,i.jsx)("div",{className:`shp-callout-title${r?" shp-callout-title-gold":""}`,children:e}),(0,i.jsx)("p",{children:s})]})}function n({children:e}){return(0,i.jsx)("div",{className:"shp-info-grid",children:e})}function l({title:e,children:s}){return(0,i.jsxs)("div",{className:"shp-info-box",children:[(0,i.jsx)("h4",{children:e}),(0,i.jsx)("p",{children:s})]})}function c({items:e}){return(0,i.jsx)("ul",{className:"shp-bullet-list",children:e.map((e,s)=>(0,i.jsxs)("li",{children:[(0,i.jsx)("div",{className:"shp-bullet-dot"}),(0,i.jsx)("span",{children:e})]},s))})}function d(){let[e,d]=(0,s.useState)("offline");return(0,s.useEffect)(()=>{let e=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&d(e.target.id)})},{threshold:.3,rootMargin:"-10% 0px -65% 0px"});return r.forEach(({id:i})=>{let s=document.getElementById(i);s&&e.observe(s)}),()=>e.disconnect()},[]),(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("style",{children:`
      ...
      `}),(0,i.jsxs)("div",{className:"shp-wrap",children:[(0,i.jsxs)("aside",{className:"shp-sidebar",children:[(0,i.jsx)("span",{className:"shp-sidebar-label",children:"Sections"}),(0,i.jsx)("nav",{className:"shp-sidebar-nav","aria-label":"Privacy policy sections",children:r.map(({id:s,icon:r,label:o})=>(0,i.jsxs)("button",{className:`shp-sidebar-btn${e===s?" active":""}`,onClick:()=>{document.getElementById(s)?.scrollIntoView({behavior:"smooth"})},children:[(0,i.jsx)("span",{className:"shp-sidebar-icon",children:r}),o]},s))})]}),(0,i.jsxs)("main",{className:"shp-main",children:[(0,i.jsxs)("div",{className:"shp-header-card",children:[(0,i.jsx)("div",{className:"shp-eyebrow",children:"🌸 She Health – Health Tracking App"}),(0,i.jsx)("h1",{className:"shp-h1 sh-font-display",children:"Privacy Policy"}),(0,i.jsx)("div",{className:"shp-meta",children:"🕐 Last updated: March 5, 2026"}),(0,i.jsx)("div",{className:"shp-highlights",children:[{icon:"📱",title:"Offline-Only",desc:"All health logs stored locally in an encrypted on-device database."},{icon:"👤",title:"No Login Needed",desc:"We do not collect names, emails, or any credentials."},{icon:"☁️",title:"Private Backups",desc:"Optional backups go only to your personal iCloud or Google Drive."}].map(e=>(0,i.jsxs)("div",{className:"shp-highlight",children:[(0,i.jsx)("div",{className:"shp-hl-icon",children:e.icon}),(0,i.jsxs)("div",{children:[(0,i.jsx)("div",{className:"shp-hl-title",children:e.title}),(0,i.jsx)("div",{className:"shp-hl-desc",children:e.desc})]})]},e.title))})]}),(0,i.jsxs)("div",{className:"shp-content-card",children:[(0,i.jsxs)("div",{className:"shp-policy-section",id:"offline",children:[(0,i.jsx)(o,{icon:"📱",title:"Offline-First Architecture"}),(0,i.jsxs)("p",{children:[(0,i.jsx)("strong",{children:"She Health"})," is built with a core philosophy of local privacy. Unlike many health apps, we do not require account registration, email submission, or any social media login to function."]}),(0,i.jsx)(t,{title:"Local Storage Only",children:"Your health logs — period data, incontinence records, hydration entries, secure gallery images, and contacts — are stored exclusively on your device. We have no central server that receives or stores your personal health data."}),(0,i.jsx)("p",{children:"Your data is encrypted using hardware-level encryption provided by your iOS or Android operating system. It does not leave your device unless you choose to initiate an optional backup."})]}),(0,i.jsx)(a,{}),(0,i.jsxs)("div",{className:"shp-policy-section",id:"collection",children:[(0,i.jsx)(o,{icon:"🗂️",title:"Data We Collect"}),(0,i.jsx)("p",{children:"Because we do not have user accounts, we do not collect personal identifiers. The data that remains on your device includes:"}),(0,i.jsx)(c,{items:[(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("strong",{children:"Health Logs:"})," Period entries, incontinence episodes, Kegel exercise sets, hydration records, and symptom notes."]}),(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("strong",{children:"Gallery Images:"})," Sensitive photos stored in the secure gallery, kept separate from your device photo library."]}),(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("strong",{children:"Contact Vault:"})," Names, professions, notes, and messaging links you choose to store in the private contact vault."]}),(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("strong",{children:"Anonymous Diagnostics:"})," We may process non-identifiable crash reports and app version data to improve reliability. These are never linked to your identity."]})]}),(0,i.jsx)("p",{children:"Your health content stays on-device. Advertising and purchase providers may process limited technical identifiers as described below."})]}),(0,i.jsx)(a,{}),(0,i.jsxs)("div",{className:"shp-policy-section",id:"advertising",children:[(0,i.jsx)(o,{icon:"📢",title:"Advertising (Google AdMob)"}),(0,i.jsx)("p",{children:"She Health may show ads in the free experience using Google AdMob. We do not provide your private health logs to ad networks."}),(0,i.jsxs)(n,{children:[(0,i.jsx)(l,{title:"Ad Provider",children:"Ads are served by Google AdMob. AdMob may process device identifiers, approximate location, IP address, and ad interaction events according to Google policies."}),(0,i.jsx)(l,{title:"Data Separation",children:"Your period logs, incontinence records, hydration entries, secure gallery items, and contacts are not shared with AdMob for ad targeting."}),(0,i.jsx)(l,{title:"Controls",children:"You can remove ads by upgrading to Pro through in-app purchases, subject to store and app behavior."}),(0,i.jsx)(l,{title:"Provider Policy",children:"Please review Google policies for details on how AdMob handles ad-related data."})]})]}),(0,i.jsx)(a,{}),(0,i.jsxs)("div",{className:"shp-policy-section",id:"purchases",children:[(0,i.jsx)(o,{icon:"💳",title:"Pro Subscription & One-Time Purchase"}),(0,i.jsx)("p",{children:"She Health provides one recurring Pro subscription and one one-time Pro purchase option. Both are processed entirely through Apple or Google. We never receive or store your billing information."}),(0,i.jsx)(t,{title:"Pro Subscription",children:"The auto-renewing Pro subscription unlocks all premium themes for appearance personalization, advanced period log trends, advanced incontinence log trends, and removes ads for all features. It also enables backup capabilities: on Android, data backs up to your private Google Drive “App Data” folder; on iOS, data backs up to your private iCloud Drive container. We have no access to these files."}),(0,i.jsx)(t,{title:"One-Time Purchase (Lifetime Pro)",gold:!0,children:"A non-consumable one-time purchase is also available to unlock the same Pro capabilities without recurring renewal: all premium themes, advanced period log trends, advanced incontinence log trends, and no ads for any feature."}),(0,i.jsxs)(n,{children:[(0,i.jsx)(l,{title:"Secure Payments",children:"All transactions are processed by Apple App Store (iOS) or Google Play (Android). The developer never sees or stores your credit card or billing details."}),(0,i.jsx)(l,{title:"Purchase Verification",children:"The app uses anonymous, cryptographically signed store receipts to unlock Pro features locally on your device."}),(0,i.jsx)(l,{title:"Subscription Renewal",children:"Pro subscriptions auto-renew unless cancelled at least 24 hours before the current period ends."}),(0,i.jsx)(l,{title:"Refunds",children:"All refund requests for Pro subscriptions and the one-time purchase are handled by Apple or Google through their standard refund processes."})]})]}),(0,i.jsx)(a,{}),(0,i.jsxs)("div",{className:"shp-policy-section",id:"backups",children:[(0,i.jsx)(o,{icon:"☁️",title:"User-Managed Cloud Backups"}),(0,i.jsxs)("p",{children:["To protect against data loss, She Health offers an ",(0,i.jsx)("strong",{children:"optional"})," backup feature managed entirely by you. We do not access, view, or store your backup files."]}),(0,i.jsxs)(n,{children:[(0,i.jsx)(l,{title:"🍎 iCloud Drive (iOS)",children:"Backups are encrypted and saved to your private iCloud container. Only you can access these files."}),(0,i.jsx)(l,{title:"▶ Google Drive (Android)",children:"Backups are saved to a private “App Data” folder on your Google Drive, inaccessible to us or other apps."})]}),(0,i.jsx)("p",{children:"Backup includes health logs and, optionally, secure gallery photos. The backup feature requires an active premium subscription."})]}),(0,i.jsx)(a,{}),(0,i.jsxs)("div",{className:"shp-policy-section",id:"platforms",children:[(0,i.jsx)(o,{icon:"🔗",title:"Platform & Privacy Links"}),(0,i.jsx)("p",{children:"She Health relies on the following platform services. For details on how they handle data, please review their privacy policies:"}),(0,i.jsxs)("div",{className:"shp-platform-links",children:[(0,i.jsxs)("a",{href:"https://www.apple.com/legal/privacy/",target:"_blank",rel:"noreferrer",className:"shp-platform-link",children:["Apple Privacy Policy ",(0,i.jsx)("span",{children:"↗"})]}),(0,i.jsxs)("a",{href:"https://policies.google.com/privacy",target:"_blank",rel:"noreferrer",className:"shp-platform-link",children:["Google Privacy Policy ",(0,i.jsx)("span",{children:"↗"})]}),(0,i.jsxs)("a",{href:"https://policies.google.com/technologies/ads",target:"_blank",rel:"noreferrer",className:"shp-platform-link",children:["Google Ads & AdMob Policy ",(0,i.jsx)("span",{children:"↗"})]})]})]}),(0,i.jsx)(a,{}),(0,i.jsxs)("div",{className:"shp-policy-section",id:"usage",children:[(0,i.jsx)(o,{icon:"ℹ️",title:"How Data Is Used"}),(0,i.jsx)("p",{children:"Health-data processing occurs locally on your device. Data is used for:"}),(0,i.jsx)(c,{items:["Calculating cycle predictions and hydration goal completion.","Scheduling local push notification reminders.","Generating health trend charts within the app.","Restoring premium status via store receipts.","Executing user-initiated cloud backups.","Serving ads in the free tier through Google AdMob."]}),(0,i.jsx)("p",{children:"We do not use your private health logs for advertising or profiling. Ad delivery and ad measurement are handled by AdMob under Google policies."})]}),(0,i.jsx)(a,{}),(0,i.jsxs)("div",{className:"shp-policy-section",id:"permissions",children:[(0,i.jsx)(o,{icon:"🔔",title:"App Permissions"}),(0,i.jsx)("p",{children:"She Health may request the following device permissions:"}),(0,i.jsxs)(n,{children:[(0,i.jsx)(l,{title:"Notifications",children:"To send local hydration reminders and health check-in prompts according to your configured schedule."}),(0,i.jsx)(l,{title:"Cloud Storage",children:"To write backup files to your personal iCloud or Google Drive account (only when you initiate a backup)."}),(0,i.jsx)(l,{title:"Camera & Photo Library",children:"To add photos to the secure gallery. Images are stored within the app, not synced to your device gallery."}),(0,i.jsx)(l,{title:"Biometrics",children:"To authenticate app access using Face ID or fingerprint. Biometric data never leaves your device."})]})]}),(0,i.jsx)(a,{}),(0,i.jsxs)("div",{className:"shp-policy-section",id:"security",children:[(0,i.jsx)(o,{icon:"🔒",title:"Security & Retention"}),(0,i.jsxs)(n,{children:[(0,i.jsx)(l,{title:"🛡️ Native Encryption",children:"Your data benefits from hardware-level encryption built into your iOS or Android device."}),(0,i.jsx)(l,{title:"🗑️ Immediate Deletion",children:"Uninstalling the app immediately and permanently deletes all locally stored data from your device."})]}),(0,i.jsx)("p",{children:"We retain no copies of your personal data on any server. Data retention is entirely controlled by you."})]}),(0,i.jsx)(a,{}),(0,i.jsxs)("div",{className:"shp-policy-section",id:"rights",children:[(0,i.jsx)(o,{icon:"✅",title:"User Rights"}),(0,i.jsx)("p",{children:"As an offline-first app, you retain complete ownership and control of your data at all times."}),(0,i.jsx)(c,{items:[(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("strong",{children:"Access:"})," View all your health data within the app at any time."]}),(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("strong",{children:"Modify:"})," Edit or update any entry directly within the app."]}),(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("strong",{children:"Delete:"})," Remove individual entries or all data via app settings."]}),(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("strong",{children:"Export:"})," Back up your data using the optional cloud backup feature."]})]}),(0,i.jsx)("p",{children:"We comply with global privacy standards including GDPR and CCPA. Because no personal data is transmitted to our servers, most traditional data request processes are not applicable — your device is the only place your data lives."})]}),(0,i.jsx)(a,{}),(0,i.jsxs)("div",{className:"shp-policy-section",id:"contact",children:[(0,i.jsx)(o,{icon:"✉️",title:"Contact Us"}),(0,i.jsxs)("div",{className:"shp-contact-card",children:[(0,i.jsx)("h4",{children:"Developer Contact"}),(0,i.jsx)("p",{children:"For any questions about this Privacy Policy or She Health's privacy architecture, please reach out:"}),(0,i.jsx)("a",{href:"mailto:subraatakumar+shehealth@gmail.com",className:"shp-contact-link",children:"✉️ subraatakumar+shehealth@gmail.com"})]})]}),(0,i.jsxs)("div",{className:"shp-page-footer",children:[(0,i.jsx)("p",{children:"She Health – Health Tracking App"}),(0,i.jsxs)("p",{children:["© ",new Date().getFullYear()," She Health. All rights reserved."]})]})]})]})]})]})}e.s(["default",()=>d])}]);
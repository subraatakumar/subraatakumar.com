        ...
        <div style={{
          ...
          <PolicySection id="rights" title="User Rights" icon={<UserCheck style={{ width: 18, height: 18 }} />}>
            <p style={{ margin: 0, fontSize: 14 }}>
              You retain full ownership of your mood logs. You may modify, delete, or export your data at any time within the app settings. We do not require account registration; third-party services such as app stores, Firebase Analytics, and AdMob process limited technical data under their own privacy terms.
            </p>
          </PolicySection>
